...
{% warning(header="Caution") %} This was written shortly after the educational sector returned to relative normalcy after the Covid-19 pandemic and just before ChatGPT sent it back into a doom spiral.{% end %}
