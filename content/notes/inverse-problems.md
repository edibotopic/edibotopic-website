...
description = "Working backwards from observations to find causes"
draft = false
date = 2024-09-08
...
Solving an inverse problem may require its conversion into a tractable set of forward problems.

If we want to work on something important or revolutionary we should seek out new inverse problems. At the same time we need to be wary of metaphorical thinking that can needlessly multiply the inverse problems that we need to solve.
